...
class SNMPManager:
    ...
    def __init__(
        self, config: Dict = None, community: str = "public", timeout: int = 1, retries: int = 1
    ):
    ...
    def _get_mock_snmp_data(self, device: Dict) -> Dict:
        ...
        if device_type == "router":
            ...
            mock_data.update({"interface_count": 48, "vlan_count": 12, "mac_table_size": 2048})
            ...
            mock_data.update(
                {"model": "HP LaserJet Pro 400", "pages_printed": 15420, "toner_level": 65}
            )
