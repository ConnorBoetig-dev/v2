  ...
  <host>
    ...
    def test_change_tracking_workflow(self):
        ...
        with patch.object(self.tracker, "_get_previous_scan") as mock_prev:
            ...
            port_changes = [
                c for c in changes2["changed_devices"][0]["changes"] if c["field"] == "ports"
            ]
...
class TestVisualizationIntegration(unittest.TestCase):
    ...
    def test_visualization_data_generation(self):
        ...
        devices = [
            ...
            {"ip": "192.168.1.20", "type": "server", "hostname": "webserver"},
            {"ip": "192.168.1.30", "type": "workstation", "hostname": "ws01"},
        ]
...
class TestEndToEndScenarios(unittest.TestCase):
    ...
    def test_new_device_detection_scenario(self):
        ...
        updated_network = initial_network + [
            {"ip": "192.168.1.50", "mac": "11:22:33:44:55:66", "type": "unknown", "hostname": ""}
        ]
    ...
    def test_service_change_scenario(self):
        ...
        # Mark as critical
        annotation = DeviceAnnotation(
            ip="192.168.1.100", critical=True, notes="Production database - monitor closely"
        )
    ...
    def test_network_growth_scenario(self):
        ...
        week1_network = [{"ip": f"192.168.1.{i}", "type": "workstation"} for i in range(1, 11)]
        ...
        week2_network = [{"ip": f"192.168.1.{i}", "type": "workstation"} for i in range(1, 21)]
