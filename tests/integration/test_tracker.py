...
class TestChangeTracker:
    ...
    def test_compare_devices_ports(self, tracker):
        ...
        old = {"ip": "10.0.1.1", "open_ports": [22, 80, 443]}
        new = {"ip": "10.0.1.1", "open_ports": [22, 443, 8080]}
    ...
    def test_compare_devices_services(self, tracker):
        ...
        old = {"ip": "10.0.1.1", "services": ["ssh", "http", "https"]}
        new = {"ip": "10.0.1.1", "services": ["ssh", "https", "snmp"]}
    ...
    def test_compare_devices_attributes(self, tracker):
        ...
        old = {"ip": "10.0.1.1", "hostname": "oldname", "os": "Ubuntu 18.04", "vendor": "Dell"}
        new = {"ip": "10.0.1.1", "hostname": "newname", "os": "Ubuntu 20.04", "vendor": "Dell"}
    ...
    def test_ip_change_detection(self, tracker):
        ...
        old = [{"ip": "10.0.1.1", "mac": "00:11:22:33:44:55", "hostname": "device01"}]
        new = [
            {
