...
class TestEnhancedScanner:
    ...
    def test_interface_detection(self, mock_run, scanner):
        ...
        mock_run.return_value = Mock(
            returncode=0, stdout="192.168.1.1 via 192.168.1.1 dev eth0 src 192.168.1.100", text=True
        )
    ...
    def test_result_merging(self, scanner):
        ...
        arp_devices = [{"ip": "192.168.1.1", "mac": "00:11:22:33:44:55", "vendor": "Cisco"}]

        nmap_devices = [{"ip": "192.168.1.1", "open_ports": [22, 80], "services": ["ssh", "http"]}]
