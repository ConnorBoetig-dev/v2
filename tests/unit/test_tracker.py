...
from core.tracker import ChangeReport, ChangeTracker, ChangeType, DeviceChange
...
class TestChangeReport(unittest.TestCase):
    ...
    def test_change_report_severity(self):
        ...
        report = ChangeReport(missing_devices=[{"ip": "192.168.1.1"}])
        self.assertEqual(report.get_severity(), "critical")

        # Warning severity for new devices
        report = ChangeReport(new_devices=[{"ip": "192.168.1.1"}])
...
class TestChangeTracker(unittest.TestCase):
    ...
    def test_detect_changes_new_devices(self):
        ...
        current_scan = [
            ...
            {"ip": "192.168.1.10", "mac": "AA:BB:CC:DD:EE:FF", "type": "workstation"},
        ]
    ...
    def test_detect_changes_missing_devices(self):
        ...
        with patch.object(self.tracker, "_get_previous_scan") as mock_prev:
            ...
            current_scan = [{"ip": "192.168.1.1", "mac": "00:11:22:33:44:55"}]
    ...
    def test_empty_scan_handling(self):
        ...
        previous = [{"ip": "192.168.1.1"}, {"ip": "192.168.1.2"}]
    ...
    def test_os_change_detection(self):
        ...
        previous = [{"ip": "192.168.1.1", "mac": "00:11:22:33:44:55", "os": "Windows 10"}]

        current = [{"ip": "192.168.1.1", "mac": "00:11:22:33:44:55", "os": "Windows 11"}]
    ...
    def test_type_change_detection(self):
        ...
        previous = [{"ip": "192.168.1.1", "mac": "00:11:22:33:44:55", "type": "unknown"}]

        current = [{"ip": "192.168.1.1", "mac": "00:11:22:33:44:55", "type": "router"}]
...
class TestTrackerIntegration(unittest.TestCase):
    ...
    def test_multiple_scan_workflow(self):
        ...
        with open(scan_file, "w") as f:
            json.dump({"timestamp": datetime.now().isoformat(), "devices": scan1}, f)
