...
from core.classifier import DeviceClassifier, DeviceType, DeviceSignature
...
class TestDeviceClassifier(unittest.TestCase):
    ...
    def test_init(self):
        ...
        expected_types = [
            ...
            DeviceType.DATABASE, DeviceType.WEB_SERVER, DeviceType.MAIL_SERVER,
            DeviceType.DNS_SERVER, DeviceType.WINDOWS_SERVER, DeviceType.LINUX_SERVER,
            DeviceType.PRINTER, DeviceType.NAS, DeviceType.HYPERVISOR,
            DeviceType.WORKSTATION, DeviceType.IOT, DeviceType.VOIP,
    ...
    def test_classify_device_web_server(self):
        ...
        self.assertIn(device_type, [DeviceType.WEB_SERVER, DeviceType.ROUTER, DeviceType.LINUX_SERVER])
        self.assertGreater(confidence, 0.3)
