...
class TestDevice(unittest.TestCase):
    ...
    def test_device_to_dict(self):
        ...
        device = Device(ip="192.168.1.1", mac="AA:BB:CC:DD:EE:FF", open_ports=[22, 443])
...
class TestScanParser(unittest.TestCase):
    ...
    def test_parse_results_arp_scan(self):
        ...
        arp_data = [
            {"ip": "192.168.1.1", "mac": "AA:BB:CC:DD:EE:FF", "vendor": "Cisco Systems, Inc."}
        ]
    ...
    def test_service_normalization(self):
        ...
        devices = [{"ip": "192.168.1.1", "services": [22, "http", "https:443", "ssh:22"]}]
...
class TestParserIntegration(unittest.TestCase):
    ...
    def test_mixed_scanner_data(self):
        ...
        # Masscan data
        masscan_data = [{"ip": "192.168.1.10", "ports": [{"port": 22}, {"port": 3306}]}]
        ...
        # ARP data
        arp_data = [{"ip": "192.168.1.20", "mac": "AA:BB:CC:DD:EE:FF", "vendor": "Dell Inc."}]
    ...
    def test_real_world_data_formats(self):
        ...
        mixed_data = [
            ...
            {"ip": "192.168.1.3", "services": ["SSH (22)", "HTTP - Port 80", "443/tcp https"]},
