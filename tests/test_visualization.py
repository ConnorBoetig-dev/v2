...
class TestMapGenerator:
    ...
    def sample_devices(self):
        ...
        return [
            {'ip': '10.0.1.1', 'hostname': 'router01', 'type': 'router', 
             'mac': '00:11:22:33:44:55', 'critical': True},
            {'ip': '10.0.1.2', 'hostname': 'switch01', 'type': 'switch',
             'mac': '00:11:22:33:44:56'},
            {'ip': '10.0.1.3', 'hostname': 'switch02', 'type': 'switch',
             'mac': '00:11:22:33:44:57'},
            {'ip': '10.0.2.1', 'hostname': 'web01', 'type': 'web_server',
             'mac': '00:11:22:33:44:58'},
            {'ip': '10.0.2.2', 'hostname': 'db01', 'type': 'database',
             'mac': '00:11:22:33:44:59', 'critical': True},
            {'ip': '10.0.3.1', 'hostname': 'ws01', 'type': 'workstation',
             'mac': '00:11:22:33:44:60'},
            {'ip': '10.0.3.2', 'hostname': 'ws02', 'type': 'workstation',
    ...
    def test_link_generation(self, visualizer, sample_devices):
        ...
        for switch_ip in switch_ips:
            link_exists = any(
                (l['source'] == '10.0.1.1' and l['target'] == switch_ip) or
                (l['source'] == switch_ip and l['target'] == '10.0.1.1')
    ...
    def test_generate_traffic_flow_data(self, visualizer, sample_devices, sample_flow_matrix):
        ...
        ws1_to_web = next(
            l for l in traffic_links 
            if l['source'] == '10.0.3.1' and l['target'] == '10.0.2.1'
        )
