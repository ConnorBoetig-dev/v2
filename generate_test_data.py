...
def generate_test_devices():
    ...
    for i, name in enumerate(workstation_names, 20):
        devices.append({
            ...
            "services": ["microsoft-ds:445"] if "Windows" in random.choice(["Windows 11 Pro", "Windows 10 Pro", "macOS Sonoma"]) else [],
            "open_ports": [445] if "Windows" in random.choice(["Windows 11 Pro", "Windows 10 Pro", "macOS Sonoma"]) else [],
            "critical": False,
